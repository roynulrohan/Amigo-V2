        ...
        <div className='flex-grow'>
            {currentConversation ? (
                <div className='bg-dark text-white h-screen flex flex-col'>
                        ...
                        {currentConversation.messages.map((message, index) => {
                            ...
                            return (
                                <div key={message._id}>
                                    ...
                                    <div
                                        className={
                                            'flex items-start rounded-lg mx-4 px-5 py-3 transition-all duration-[.15] ease-in-out relative hover:bg-darkest ' +
                                            (hideTitle ? 'py-0' : '')
                                        }
                                        title={
                                            new Date(message.dateCreated).toLocaleString('en-US', {
                                        ...
                                        <div className='flex flex-col ml-16'>
                                            {hideTitle ? (
                                                ...
                                                <small className='m-0'>
                                                    <span className={auth.user.username === message.sender ? 'text-rose-500' : 'text-cyan-400'}>
                                                        {message.sender}
                                                    </span>
                    ...
                    <div className='min-h-[65px] h-[65px] flex items-center justify-center px-10 pb-3'>
                        <div className='relative h-full w-full lg:w-2/3'>
                            <button className='bg-pink-600 text absolute inset-y-0 right-0 p-2 px-4 m-2 rounded-full' onClick={() => {}}>
